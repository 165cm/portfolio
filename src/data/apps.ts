...
export const apps: App[] = [
  // ── 仕事・現場 ───────────────────────────────────────────
  {
    ...
    name: 'エアコン保健室',
    emoji: '❄️',
    tagline: '症状から次の一手を選ぶ、エアコントラブル対処ガイド',
    category: 'work',
    useCases: [
      '冷えない・水漏れ・異音・リモコン不調が起きたとき',
      '自分で確認してよい範囲と、業者に頼むべき範囲を知りたいとき',
      '修理費が高いとき、10年以上使っていて買い替えを迷うとき',
    ],
    motivation: '夏にエアコンが止まると本当に困る。業者を呼ぶ前に自分で判断できる材料が欲しくて作りました。保健室の先生とのチャット形式で、危険サイン → 自力確認 → 修理/買い替えの順に整理します。',
    tech: ['Astro', 'TypeScript', '独自ドメイン', 'GitHub Actions'],
    links: {
      demo: 'https://aircon-hokenshitsu.com/',
  ...
  },
  {
    ...
    name: 'エアコン助かるラボ',
    emoji: '🛠️',
    tagline: 'エアコンの困りごとを、業者を呼ぶ前に試して解決',
    category: 'work',
    useCases: [
      '冷えない・水漏れ・臭い・リモコン不調を自分で切り分けたいとき',
      '部屋の畳数に合ったエアコンを選びたいとき',
      '電気代やカビ・臭い対策を見直したいとき',
    ],
    motivation: '研修中のエアコン修理エンジニアとして、家庭で安全にできる範囲と業者に頼むべき範囲の境界を整理しています。もとは工具比較サイトでしたが、困っている人に届く形へ作り替えました。',
  ...
  // ── 投資・お金 ───────────────────────────────────────────
  {
    ...
    emoji: '🇺🇸',
    tagline: 'Firstrade証券の確定申告を、日本円で自動計算',
    category: 'money',
    useCases: [
      '米国株を持っていて確定申告が必要な人',
    ...
    tech: ['Next.js', 'TypeScript', 'Gumroad'],
    links: {
      demo: 'https://firstrade.nomadkazoku.com/',
